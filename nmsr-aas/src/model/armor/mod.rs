...
impl VanillaMinecraftArmorTrimPalette {
    #[must_use]
    const fn get_trim_palette() -> [u8; 8] {
    ...
    pub const fn get_palette_colors(&self) -> [[u8; 3]; 8] {
        ...
        match self {
            ...
            Self::Resin => [[0x80, 0x2A, 0x1A], [0xA5, 0x3B, 0x11], [0xC7, 0x49, 0x0A], [0xDB, 0x5F, 0x10], [0xEC, 0x72, 0x14], [0xF0, 0x85, 0x2A], [0xF6, 0x9F, 0x3B], [0xFF, 0xC3, 0x54]],
        }
    }
...
impl From<VanillaMinecraftArmorTrimMaterial> for VanillaMinecraftArmorTrimPalette {
    fn from(value: VanillaMinecraftArmorTrimMaterial) -> Self {
        match value {
            ...
            VanillaMinecraftArmorTrimMaterial::Resin => Self::Resin,
        }
    }
}
